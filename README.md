...
* [2. Tarjetas Pokémon Interactivas:](#2-Tarjetas-Pokémon-Interactivas:)
* [3. Filtros de Tipo Pokémon:](#3-Filtros-de-Tipo-Pokémon:)
* [4. Ordenación Ascendente y Descendente:](#4-consideraciones-generales)
* [5. Estadísticas por Generación Kanto:](#5-criterios-de-aceptación-mínimos-del-proyecto)
...
Este proyecto DataLovers se enfocó en crear una aplicación web interactiva centrada en las tarjetas Pokémon, ofreciendo una experiencia atractiva y útil para los fanáticos de Pokémon y los entusiastas de la estadística. A continuación, se presentan sus principales características:

![pokemon-data-to-ui](C:\Users\lizet\OneDrive\Documents\POKEMON\DEV010-data-lovers\test\tipos.gif)
